...
<head>
  ...
  <title>Add Snippet | CodeVault</title>
  ...
  <header class="navbar">
    <div class="navbar-container">
      ...
      <nav class="nav-menu">
        ...
        <a href="${pageContext.request.contextPath}/addSnippet.jsp" class="nav-link active">Add Snippet</a>
  ...
  <main class="app-main editor-main">
    ...
    <div class="glass-card editor-card fade-in delay-1">
      <div class="editor-header">
        <h2 class="editor-title">Create Snippet</h2>
      </div>
      ...
      <form action="${pageContext.request.contextPath}/addSnippet" method="post" id="addSnippetForm">
        <div class="form-group">
          ...
          <input class="form-control" type="text" id="title" name="title" placeholder="e.g. Binary Search implementation" required />
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description" placeholder="Provide a brief explanation of what this snippet solves..." rows="3" required></textarea>
        </div>
