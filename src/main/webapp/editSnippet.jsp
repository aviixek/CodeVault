...
<head>
  ...
  <style>
    ...
    * {
    ...
    /* Select dropdown styling overrides */
    .select-control {
      appearance: none;
      -webkit-appearance: none;
      -moz-appearance: none;
      background-image: url("data:image/svg+xml;utf8,<svg fill='none' stroke='%23888888' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' height='18' width='18' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><polyline points='6 9 12 15 18 9'></polyline></svg>");
    ...
    body.light-theme .select-control {
      background-image: url("data:image/svg+xml;utf8,<svg fill='none' stroke='%23333333' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' height='18' width='18' viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg'><polyline points='6 9 12 15 18 9'></polyline></svg>");
    }
...
<body>
  ...
  <main class="app-main editor-main">
    <div class="back-btn-container fade-in">
      <a href="${pageContext.request.contextPath}/dashboard.jsp" class="back-link">
    ...
    <div class="glass-card editor-card fade-in delay-1">
      <div class="editor-header">
        <h2 class="editor-title">Edit Snippet</h2>
      </div>
      ...
      <form action="${pageContext.request.contextPath}/editSnippet" method="post" id="editSnippetForm">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" id="title" name="title" value="${snippet.title}" placeholder="e.g. Binary Search implementation" required />
        </div>
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" id="description" name="description" placeholder="Provide a brief explanation of what this snippet solves..." rows="3" required>${snippet.description}</textarea>
        </div>
        ...
        <div class="editor-actions">
          <a href="${pageContext.request.contextPath}/dashboard.jsp" class="btn btn-secondary btn-editor">Cancel</a>
          <button class="btn btn-primary btn-editor" type="submit" id="saveBtn" style="position: relative;">
            <span class="btn-text">Update Snippet</span>
            <span class="spinner" style="display: none; width: 16px; height: 16px; border: 2px solid currentColor; border-top-color: transparent; border-radius: 50%; position: absolute; top: calc(50% - 8px); left: calc(50% - 8px); animation: spin 0.8s linear infinite;"></span>
          </button>
        </div>
      </form>
    </div>
