    ...
    <div class="glass-card auth-card fade-in delay-1">
      ...
      <form action="${pageContext.request.contextPath}/RegisterServlet" method="post" id="registerForm">
        ...
        <div class="form-group">
          ...
          <input class="form-control" type="text" id="username" name="username" placeholder="e.g. dev_coder" required minlength="3" maxlength="30" pattern="^[a-zA-Z0-9_]{3,30}$" title="3-30 characters: letters, numbers, and underscores only" autocomplete="username" />
        </div>
