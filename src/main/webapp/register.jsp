...
<head>
  ...
  <style>
    ...
    * {
    ...
    body.light-theme .strength-bar-track {
  ...
  <main class="app-main auth-main">
    <div class="glass-card auth-card fade-in delay-1">
      <div class="auth-header">
        ...
        <p class="auth-subtitle">Join CodeVault to manage snippets safely</p>
      </div>
      
      <!-- JSTL Error Alert -->
      <c:if test="${not empty error}">
        <div class="banner-error" id="serverError">
      ...
      <div class="banner-error" id="clientError" style="display: none;">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="12" cy="12" r="10"></circle>
          <line x1="12" y1="8" x2="12" y2="12"></line>
          <line x1="12" y1="16" x2="12.01" y2="16"></line>
        </svg>
        <span id="clientErrorMessage">Passwords do not match</span>
      </div>
      ...
      <div class="form-group">
        ...
        <div class="form-group">
          ...
          <div class="strength-container">
            ...
            <span id="strengthText" class="strength-label">Strength: Empty</span>
          </div>
        </div>
